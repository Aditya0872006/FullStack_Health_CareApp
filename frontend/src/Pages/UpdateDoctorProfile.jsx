...
const UpdateDoctorProfile = () => {
        ...
        try {
            ...
            if (response.data.statusCode === 200) {
                ...
                setFormData({
                    ...
                    specilization: doctorData.specilization || ''
                });
            }
    ...
    const fetchspecilizations = async () => {
        try {
            const response = await apiService.getAllDoctorSpecializations();

            if (response.data.statusCode === 200) {
                setspecilizations(response.data.data);
            }

        } catch (error) {
            setError('Failed to load specilizations');
            ...
            <div className="form-container">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        >
                            <option value="">Select your specilization</option>
                            {specilizations.map((spec) => (
                        ...
                        {loadingEnums && (
                            <small className="form-help">Loading specilizations...</small>
                        )}
                    </div>
